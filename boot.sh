...
if [ $1 == "UNO" ]; then
    ...
    $TOOLS/bin/avrdude -C/$TOOLS/etc/avrdude.conf -v -B1 -pm328p -cusbtiny -Pusb -Uflash:w:$ARDUINO/bootloaders/optiboot/optiboot_atmega328.hex:i
    ...
    $TOOLS/bin/avrdude -C/$TOOLS/etc/avrdude.conf -v -B1 -pm2560 -cusbtiny -Pusb -Uflash:w:$ARDUINO/bootloaders/stk500v2/stk500boot_v2_mega2560.hex:i
